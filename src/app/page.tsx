...
export default function Home() {
  ...
  return (
    ...
    <main onMouseDown={toggleCollapsed} className={"grid grid-rows-14 w-full h-screen overflow-hidden bg-Mevkgreen "}>
      ...
      <section  className={!slidebar ? "w-full h-full row-span-12 bg-zinc-950 overflow-auto scrollbar-thin scrollbar-thumb-slate-400 scrollbar-track-slate-200 " : "w-full h-full row-span-12  bg-black overflow-auto scrollbar-thin scrollbar-thumb-slate-400 scrollbar-track-slate-200 blur-sm pointer-events-none"}>
        ...
        <div className="w-full h-auto bg-transparent flex flex-col items-center">
          <div className="flex flex-col items-center  gap-20 w-full h-auto  pt-20 ">
            ...
            <Link className="transition duration-700 ease-in-out rounded-3xl w-5/6 h-80  bg-gradient-to-tr from-Mevkgreen  to-white shadow-lg text-center flex justify-evenly transform hover:-translate-y-1 hover:scale-105" href={"/receita"}>
              <Button className="rounded-3xl w-full h-80 bg-gradient-to-tr from-Mevkgreen via-Mevkgreen to-white  text-center flex items-center justify-between p-0 m-0">
            ...
            <Link className="transition duration-700 ease-in-out rounded-3xl w-5/6 h-80  bg-gradient-to-tr from-Mevkgreen  to-white shadow-lg text-center flex justify-evenly transform hover:-translate-y-1 hover:scale-105" href={"/exercicios"}>
              <Button className="rounded-3xl w-full h-80 bg-gradient-to-tr from-Mevkgreen via-Mevkgreen to-white  text-center flex items-center justify-between p-0 m-0">
