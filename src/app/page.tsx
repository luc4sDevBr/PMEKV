        ...
        <div className="w-full h-auto bg-transparent flex flex-col items-center">
          ...
          <Link href={"/inicio"} className="transition duration-700 ease-in-out rounded-3xl w-11/12 md:w-5/6 h-40 md:h-80 min-w-[300px] max-w-[1200px] text-center flex justify-evenly transform hover:-translate-y-1 hover:scale-105">
              <Button className="rounded-3xl w-full h-full bg-gradient-to-tr from-Mevkgreen via-Mevkgreen to-white text-center flex items-center justify-between p-0 m-0">
                ...
                <Image className="rounded-s-full w-2/5 md:w-3/5 h-full max-h-[240px] md:max-h-[320px] text-white text-center flex items-center justify-center" src={"/card1.jpg"} width={1000} height={500} alt="img" />
              </Button>
            </Link>
            <Link href={"/tabela"} className="transition duration-700 ease-in-out rounded-3xl w-11/12 md:w-5/6 h-40 md:h-80 min-w-[300px] max-w-[1200px] text-center flex justify-evenly transform hover:-translate-y-1 hover:scale-105">
              <Button className="rounded-3xl w-full h-full bg-gradient-to-tr from-Mevkgreen via-Mevkgreen to-white text-center flex items-center justify-between p-0 m-0">
                <h1 className="drop-shadow-lg text-3xl md:text-6xl font-semibold text-white w-full">Restrições durante o desafio.</h1>
                <Image className="rounded-s-full w-2/5 md:w-3/5 h-full max-h-[240px] md:max-h-[320px] text-white text-center flex items-center justify-center" src={"/card1.jpg"} width={1000} height={500} alt="img" />
              </Button>
            </Link>
            <Link href={"/receita"} className="transition duration-700 ease-in-out rounded-3xl w-11/12 md:w-5/6 h-40 md:h-80 min-w-[300px] max-w-[1200px] text-center flex justify-evenly transform hover:-translate-y-1 hover:scale-105">
              <Button className="rounded-3xl w-full h-full bg-gradient-to-tr from-Mevkgreen via-Mevkgreen to-white text-center flex items-center justify-between p-0 m-0">
                <h1 className="drop-shadow-lg text-3xl md:text-6xl font-semibold text-white w-full">Receita detóx</h1>
                <Image className="rounded-s-full w-2/5 md:w-3/5 h-full max-h-[240px] md:max-h-[320px] text-white text-center flex items-center justify-center" src={"/card1.jpg"} width={1000} height={500} alt="img" />
              </Button>
            </Link>
            <Link href={"/tabela"} className="transition duration-700 ease-in-out rounded-3xl w-11/12 md:w-5/6 h-40 md:h-80 min-w-[300px] max-w-[1200px] text-center flex justify-evenly transform hover:-translate-y-1 hover:scale-105">
              <Button className="rounded-3xl w-full h-full bg-gradient-to-tr from-Mevkgreen via-Mevkgreen to-white text-center flex items-center justify-between p-0 m-0">
                <h1 className="drop-shadow-lg text-3xl md:text-6xl font-semibold text-white w-full">Fórmulas de manipulados</h1>
                <Image className="rounded-s-full w-2/5 md:w-3/5 h-full max-h-[240px] md:max-h-[320px] text-white text-center flex items-center justify-center" src={"/card1.jpg"} width={1000} height={500} alt="img" />
              </Button>
            </Link>
            <Link href={"/exercicios"} className="transition duration-700 ease-in-out rounded-3xl w-11/12 md:w-5/6 h-40 md:h-80 min-w-[300px] max-w-[1200px] bg-gradient-to-tr from-Mevkgreen to-white shadow-lg text-center flex justify-evenly transform hover:-translate-y-1 hover:scale-105">
              <Button className="rounded-3xl w-full h-full bg-gradient-to-tr from-Mevkgreen via-Mevkgreen to-white text-center flex items-center justify-between p-0 m-0">
                <h1 className="drop-shadow-lg text-3xl md:text-6xl font-semibold text-white w-full">Exercite-se</h1>
                <Image className="rounded-s-full w-2/5 md:w-3/5 h-full max-h-[240px] md:max-h-[320px] text-white text-center flex items-center justify-center" src={"/card1.jpg"} width={1000} height={500} alt="img" />
              </Button>
            </Link>
          </div>
