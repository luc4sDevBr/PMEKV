  ...
  return (
    <ListboxWrapper>
      <Listbox
        ...
        className=" p-0 w-full h-full text-2xl font-semibold text-left align-middle  text-white mt-2"
      ...
      >
        {(item) => (
          ...
          <ListboxItem key={item.id} textValue={item.name} className="w-full p-0 ml-0 mt-2 transition duration-700 ease-in-out bg-transparent shadow-lg text-left transform hover:-translate-y-1 hover:scale-100">
