...
declare const props$j: {
    streamingProfile: z.ZodOptional<z.ZodString>;
};
declare const assetTypes$j: string[];
declare function plugin$j(props: PluginSettings<VideoOptions>): {};

declare namespace abrPlugin {
  export { assetTypes$j as assetTypes, plugin$j as plugin, props$j as props };
}
...
declare function plugin$i(props: PluginSettings): PluginResults;
...
declare function plugin$h(props: PluginSettings<ImageOptions>): {};

declare namespace defaultImagePlugin {
  export { assetTypes$h as assetTypes, plugin$h as plugin, props$h as props };
}
...
declare function plugin$g(props: PluginSettings): {};
...
declare function plugin$f(props: PluginSettings<ImageOptions>): {};
...
declare function plugin$d(props: PluginSettings<ImageOptions>): {} | undefined;
...
export { type AssetOptions as A, type ConstructUrlProps as C, type ImageOptions as I, type PluginSettings as P, type VideoOptions as V, type AnalyticsOptions as a, type CloudinaryAnalyticsOptions as b, constructCloudinaryUrl as c, type ConfigOptions as d, type CloudinaryConfigurationOptions as e, type PluginOptions as f, type PluginResults as g, constructUrlPropsSchema as h, assetOptionsSchema as i, imageOptionsSchema as j, transformationPlugins as t, videoOptionsSchema as v };
